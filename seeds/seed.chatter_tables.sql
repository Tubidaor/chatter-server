...
VALUES
  (1, 'name@gmail.com', 'juan','baltazar', 'tubidaor', 'password'),
  (2, 'name1@gmail.com', 'bob', 'baltazar', 'testuser', 'password'),
  (3, 'name2@gmail.com', 'megan', 'baltazar', 'testuser1', 'password'),
  (4, 'name3@gmail.com', 'mara', 'baltazar', 'testuser2', 'password');
